...
name_restart    = 'output_data_2800.csv'  # Name of restart data [-]
######################################################################
...
R2_R1           = 2.0  # Chamber-convergent arc ratio as (R2/R1)
...
def drc_dz_segments(drc_dx, phys_mesh, R1, R2, Rexp, theta, alpha, x1, x2, xc, xexp):
    for i in range(0, num_grid_x+2):
        ...
        if x >= x1 and x < 0.0:
            ...
            drc_dx[i] = (x / R1) * (1.0 / np.sqrt(1-(-x/R1)**2))
        elif x < x1 and x > x2:
            # print("x1 > x > x2")
            # print(theta)
    ...
    for i in range(1, num_grid_x + 1):
        for j in range(1, num_grid_y + 1):
            for k in range(1, num_grid_z + 1):
                ...
                # rho
                var_type = 0
                rho_F_p_x = ECKEP_flux(rho_L, rho_R, u_L, u_R, v_L, v_R, w_L, w_R, E_L, E_R, s_L, s_R, P_L, P_R, T_L, T_R,
                                     a_L, a_R, var_type)
                # rhou
                var_type = 1
                rhou_F_p_x = ECKEP_flux(rho_L, rho_R, u_L, u_R, v_L, v_R, w_L, w_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhov
                var_type = 2
                rhov_F_p_x = ECKEP_flux(rho_L, rho_R, u_L, u_R, v_L, v_R, w_L, w_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhow
                var_type = 3
                rhow_F_p_x = ECKEP_flux(rho_L, rho_R, u_L, u_R, v_L, v_R, w_L, w_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhoE
                var_type = 4
                rhoE_F_p_x = ECKEP_flux(rho_L, rho_R, u_L, u_R, v_L, v_R, w_L, w_R, E_L, E_R, s_L, s_R, P_L, P_R, T_L,
                ...
                # rho
                var_type = 0
                rho_F_m_x = ECKEP_flux(rho_L, rho_R, u_L, u_R, v_L, v_R, w_L, w_R, E_L, E_R, s_L, s_R, P_L, P_R, T_L, T_R,
                                     a_L, a_R, var_type)
                # rhou
                var_type = 1
                rhou_F_m_x = ECKEP_flux(rho_L, rho_R, u_L, u_R, v_L, v_R, w_L, w_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhov
                var_type = 2
                rhov_F_m_x = ECKEP_flux(rho_L, rho_R, u_L, u_R, v_L, v_R, w_L, w_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhow
                var_type = 3
                rhow_F_m_x = ECKEP_flux(rho_L, rho_R, u_L, u_R, v_L, v_R, w_L, w_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhoE
                var_type = 4
                rhoE_F_m_x = ECKEP_flux(rho_L, rho_R, u_L, u_R, v_L, v_R, w_L, w_R, E_L, E_R, s_L, s_R, P_L, P_R, T_L,
                                      T_R, a_L, a_R, var_type)
                ## y-direction j+1/2
                index_L = j
                index_R = j + 1
                ...
                # rho
                var_type = 0
                rho_F_p_y = ECKEP_flux(rho_L, rho_R, v_L, v_R, u_L, u_R, w_L, w_R, E_L, E_R, s_L, s_R, P_L, P_R, T_L, T_R,
                                     a_L, a_R, var_type)
                # rhou
                var_type = 2
                rhou_F_p_y = ECKEP_flux(rho_L, rho_R, v_L, v_R, u_L, u_R, w_L, w_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhov
                var_type = 1
                rhov_F_p_y = ECKEP_flux(rho_L, rho_R, v_L, v_R, u_L, u_R, w_L, w_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhow
                var_type = 3
                rhow_F_p_y = ECKEP_flux(rho_L, rho_R, v_L, v_R, u_L, u_R, w_L, w_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhoE
                var_type = 4
                rhoE_F_p_y = ECKEP_flux(rho_L, rho_R, v_L, v_R, u_L, u_R, w_L, w_R, E_L, E_R, s_L, s_R, P_L, P_R, T_L,
                                      T_R, a_L, a_R, var_type)
                ## y-direction j-1/2
                index_L = j - 1
                index_R = j
                ...
                # rho
                var_type = 0
                rho_F_m_y = ECKEP_flux(rho_L, rho_R, v_L, v_R, u_L, u_R, w_L, w_R, E_L, E_R, s_L, s_R, P_L, P_R, T_L, T_R,
                                     a_L, a_R, var_type)
                # rhou
                var_type = 2
                rhou_F_m_y = ECKEP_flux(rho_L, rho_R, v_L, v_R, u_L, u_R, w_L, w_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhov
                var_type = 1
                rhov_F_m_y = ECKEP_flux(rho_L, rho_R, v_L, v_R, u_L, u_R, w_L, w_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhow
                var_type = 3
                rhow_F_m_y = ECKEP_flux(rho_L, rho_R, v_L, v_R, u_L, u_R, w_L, w_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhoE
                var_type = 4
                rhoE_F_m_y = ECKEP_flux(rho_L, rho_R, v_L, v_R, u_L, u_R, w_L, w_R, E_L, E_R, s_L, s_R, P_L, P_R, T_L,
                                      T_R, a_L, a_R, var_type)
                ## z-direction k+1/2
                index_L = k
                index_R = k + 1
                ...
                # rho
                var_type = 0
                rho_F_p_z = ECKEP_flux(rho_L, rho_R, w_L, w_R, v_L, v_R, u_L, u_R, E_L, E_R, s_L, s_R, P_L, P_R, T_L, T_R,
                                     a_L, a_R, var_type)
                # rhou
                var_type = 3
                rhou_F_p_z = ECKEP_flux(rho_L, rho_R, w_L, w_R, v_L, v_R, u_L, u_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhov
                var_type = 2
                rhov_F_p_z = ECKEP_flux(rho_L, rho_R, w_L, w_R, v_L, v_R, u_L, u_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhow
                var_type = 1
                rhow_F_p_z = ECKEP_flux(rho_L, rho_R, w_L, w_R, v_L, v_R, u_L, u_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhoE
                var_type = 4
                rhoE_F_p_z = ECKEP_flux(rho_L, rho_R, w_L, w_R, v_L, v_R, u_L, u_R, E_L, E_R, s_L, s_R, P_L, P_R, T_L,
                                      T_R, a_L, a_R, var_type)
                ## z-direction k-1/2
                index_L = k - 1
                index_R = k
                ...
                # rho
                var_type = 0
                rho_F_m_z = ECKEP_flux(rho_L, rho_R, w_L, w_R, v_L, v_R, u_L, u_R, E_L, E_R, s_L, s_R, P_L, P_R, T_L, T_R,
                                     a_L, a_R, var_type)
                # rhou
                var_type = 3
                rhou_F_m_z = ECKEP_flux(rho_L, rho_R, w_L, w_R, v_L, v_R, u_L, u_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhov
                var_type = 2
                rhov_F_m_z = ECKEP_flux(rho_L, rho_R, w_L, w_R, v_L, v_R, u_L, u_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhow
                var_type = 1
                rhow_F_m_z = ECKEP_flux(rho_L, rho_R, w_L, w_R, v_L, v_R, u_L, u_R, E_L, E_R, s_L, s_R, P_rhouvw_L,
                                      P_rhouvw_R, T_L, T_R, a_L, a_R, var_type)
                # rhoE
                var_type = 4
                rhoE_F_m_z = ECKEP_flux(rho_L, rho_R, w_L, w_R, v_L, v_R, u_L, u_R, E_L, E_R, s_L, s_R, P_L, P_R, T_L,
                                      T_R, a_L, a_R, var_type)
                
                # print((1.0 / delta_y) * (rho_F_p_x - rho_F_m_x) * (grid[i][j][k][1] / L_y[i] * drc_dx[i]))
                # print((rho_F_p_x - rho_F_m_x))
                
                ## Fluxes x-direction (MODIFIED)
                rho_inv[i][j][k] = (1.0 / delta_x) * (rho_F_p_x - rho_F_m_x) - (1.0 / delta_y) * (rho_F_p_y - rho_F_m_y) * (grid[i][j][k][1] / L_y[i] * drc_dx[i])
                rhou_inv[i][j][k] = (1.0 / delta_x) * (rhou_F_p_x - rhou_F_m_x) - (1.0 / delta_y) * (rhou_F_p_y - rhou_F_m_y) * (grid[i][j][k][1] / L_y[i] * drc_dx[i])
                rhov_inv[i][j][k] = (1.0 / delta_x) * (rhov_F_p_x - rhov_F_m_x) - (1.0 / delta_y) * (rhov_F_p_y - rhov_F_m_y) * (grid[i][j][k][1] / L_y[i] * drc_dx[i])
                rhow_inv[i][j][k] = (1.0 / delta_x) * (rhow_F_p_x - rhow_F_m_x) - (1.0 / delta_y) * (rhow_F_p_y - rhow_F_m_y) * (grid[i][j][k][1] / L_y[i] * drc_dx[i])
                rhoE_inv[i][j][k] = (1.0 / delta_x) * (rhoE_F_p_x - rhoE_F_m_x) - (1.0 / delta_y) * (rhoE_F_p_y - rhoE_F_m_y) * (grid[i][j][k][1] / L_y[i] * drc_dx[i])

                ## Fluxes y-direction (MODIFIED)
                rho_inv[i][j][k] += (1.0 / delta_y) * (rho_F_p_y - rho_F_m_y) * (1.0 / L_y[i])
                rhou_inv[i][j][k] += (1.0 / delta_y) * (rhou_F_p_y - rhou_F_m_y) * (1.0 / L_y[i])
                rhov_inv[i][j][k] += (1.0 / delta_y) * (rhov_F_p_y - rhov_F_m_y) * (1.0 / L_y[i])
                rhow_inv[i][j][k] += (1.0 / delta_y) * (rhow_F_p_y - rhow_F_m_y) * (1.0 / L_y[i])
                rhoE_inv[i][j][k] += (1.0 / delta_y) * (rhoE_F_p_y - rhoE_F_m_y) * (1.0 / L_y[i])
    ...
    for i in range(1, num_grid_x + 1):
        for j in range(1, num_grid_y + 1):
            for k in range(1, num_grid_z + 1):
                ...
                div_tau_x = mu[i][j][k] * ((1.00 / delta_x) * (
                            (u[i + 1][j][k] - u[i][j][k]) / (grid[i + 1][j][k][0] - grid[i][j][k][0])
                            - (u[i][j][k] - u[i - 1][j][k]) / (grid[i][j][k][0] - grid[i - 1][j][k][0]))
                                           + (1.00 / delta_y) * ((u[i][j + 1][k] - u[i][j][k]) / (
                                    grid[i][j + 1][k][1] - grid[i][j][k][1])
                                                                 - (u[i][j][k] - u[i][j - 1][k]) / (
                                                                             grid[i][j][k][1] - grid[i][j - 1][k][1]))
                                           + (1.00 / delta_z) * ((u[i][j][k + 1] - u[i][j][k]) / (
                                    grid[i][j][k + 1][2] - grid[i][j][k][2])
                                                                 - (u[i][j][k] - u[i][j][k - 1]) / (
                                                                             grid[i][j][k][2] - grid[i][j][k - 1][
                                                                         2]))) + (1.0 / 3.0) * mu[i][j][k] * (
                                        (1.00 / delta_x) * (
                                            (u[i + 1][j][k] - u[i][j][k]) / (grid[i + 1][j][k][0] - grid[i][j][k][0])
                                            - (u[i][j][k] - u[i - 1][j][k]) / (grid[i][j][k][0] - grid[i - 1][j][k][0]))
                ...
                div_tau_y = mu[i][j][k] * ((1.00 / delta_x) * (
                            (v[i + 1][j][k] - v[i][j][k]) / (grid[i + 1][j][k][0] - grid[i][j][k][0])
                            - (v[i][j][k] - v[i - 1][j][k]) / (grid[i][j][k][0] - grid[i - 1][j][k][0]))
                                           + (1.00 / delta_y) * ((v[i][j + 1][k] - v[i][j][k]) / (
                                    grid[i][j + 1][k][1] - grid[i][j][k][1])
                                                                 - (v[i][j][k] - v[i][j - 1][k]) / (
                                                                             grid[i][j][k][1] - grid[i][j - 1][k][1]))
                                           + (1.00 / delta_z) * ((v[i][j][k + 1] - v[i][j][k]) / (
                                    grid[i][j][k + 1][2] - grid[i][j][k][2])
                                                                 - (v[i][j][k] - v[i][j][k - 1]) / (
                                                                             grid[i][j][k][2] - grid[i][j][k - 1][
                                                                         2]))) + (1.0 / 3.0) * mu[i][j][k] * (
                                        (0.25 / delta_y) * ((u[i + 1][j + 1][k] - u[i - 1][j + 1][k]) / delta_x
                ...
                div_tau_z = mu[i][j][k] * ((1.00 / delta_x) * (
                            (w[i + 1][j][k] - w[i][j][k]) / (grid[i + 1][j][k][0] - grid[i][j][k][0])
                            - (w[i][j][k] - w[i - 1][j][k]) / (grid[i][j][k][0] - grid[i - 1][j][k][0]))
                                           + (1.00 / delta_y) * ((w[i][j + 1][k] - w[i][j][k]) / (
                                    grid[i][j + 1][k][1] - grid[i][j][k][1])
                                                                 - (w[i][j][k] - w[i][j - 1][k]) / (
                                                                             grid[i][j][k][1] - grid[i][j - 1][k][1]))
                                           + (1.00 / delta_z) * ((w[i][j][k + 1] - w[i][j][k]) / (
                                    grid[i][j][k + 1][2] - grid[i][j][k][2])
                                                                 - (w[i][j][k] - w[i][j][k - 1]) / (
                                                                             grid[i][j][k][2] - grid[i][j][k - 1][
                                                                         2]))) + (1.0 / 3.0) * mu[i][j][k] * (
                                        (0.25 / delta_z) * ((u[i + 1][j][k + 1] - u[i - 1][j][k + 1]) / delta_x
                                        ...
                                        + (1.00 / delta_z) * ((w[i][j][k + 1] - w[i][j][k]) / (
                                            grid[i][j][k + 1][2] - grid[i][j][k][2])
                                                              - (w[i][j][k] - w[i][j][k - 1]) / (
                                                                          grid[i][j][k][2] - grid[i][j][k - 1][2]))) + (
                                        d_mu_x * tau_xz + d_mu_y * tau_yz + d_mu_z * tau_zz) / (mu[i][j][k] + epsilon)
                ## Fourier term
                div_q = (-1.0) * kappa[i][j][k] * (
                            (1.0 / delta_x) * ((T[i + 1][j][k] - T[i][j][k]) / (grid[i + 1][j][k][0] - grid[i][j][k][0])
                                               - (T[i][j][k] - T[i - 1][j][k]) / (
                                                           grid[i][j][k][0] - grid[i - 1][j][k][0]))
                            + (1.0 / delta_y) * (
                                        (T[i][j + 1][k] - T[i][j][k]) / (grid[i][j + 1][k][1] - grid[i][j][k][1])
                                        - (T[i][j][k] - T[i][j - 1][k]) / (grid[i][j][k][1] - grid[i][j - 1][k][1]))
                            + (1.0 / delta_z) * (
                                        (T[i][j][k + 1] - T[i][j][k]) / (grid[i][j][k + 1][2] - grid[i][j][k][2])
                                        - (T[i][j][k] - T[i][j][k - 1]) / (grid[i][j][k][2] - grid[i][j][k - 1][
                                    2]))) - d_kappa_x * d_T_x - d_kappa_y * d_T_y - d_kappa_z * d_T_z
...
while time_iter < max_num_time_iter:
    ...
    for rk in range(0, rk_order):
        ...
        ### Calculate inviscid fluxes
        inviscid_fluxes(rho_inv_flux, rhou_inv_flux, rhov_inv_flux, rhow_inv_flux, rhoE_inv_flux, rho_field, u_field,
                        v_field, w_field, E_field, s_field, P_field, P_thermo, T_field, sos_field, computational_plane)

        ### Calculate viscous fluxes
        viscous_fluxes(rhou_vis_flux, rhov_vis_flux, rhow_vis_flux, rhoE_vis_flux, work_vis_rhoe_flux, u_field, v_field,
                       w_field, T_field, mu_field, kappa_field, computational_plane)
        ...
        sum_fluxes_source_terms(rho_rk_fluxes, rhou_rk_fluxes, rhov_rk_fluxes, rhow_rk_fluxes, rhoE_rk_fluxes,
                                P_rk_fluxes, rho_inv_flux, rhou_inv_flux, rhov_inv_flux, rhow_inv_flux, rhoE_inv_flux,
                                rhou_vis_flux, rhov_vis_flux, rhow_vis_flux, rhoE_vis_flux, work_vis_rhoe_flux,
                                f_rhou_field, f_rhov_field, f_rhow_field, f_rhoE_field, rho_field, u_field, v_field,
                                w_field, P_field, T_field, sos_field, rk, computational_plane)
