...
output_iter     = 42000  # Select imported data iteration
...
name_file_out   = 'output_data/output_data_29-05-2026/output_data_'  # Name of output data [-]
...
surf3 = ax3.scatter(physical_plane[1:num_grid_x,1:num_grid_y,1,0], 
                       physical_plane[1:num_grid_x,1:num_grid_y,1,1], 
...
cbar3.set_label('Axial velocity [m/s]')
